       ...
       <div class="col-md-12">
            ...
            <div class="portlet light">  
                <div class="portlet-body"> 
                     <div class="table table-responsive">
                         <table class="table table-striped table-bordered " id="dataGridBRules">
                            <thead id="tblHeadBRule" class="bg-grey-silver !Important">
                ...
                <div class="portlet-body"> 
                     <div class="table table-responsive" id="tblXls" >
                         <table class="table table-striped table-bordered " id="dataGridBXlsMapp">
                              <thead id="tblHeadBXlsMapp" class="bg-grey-silver !Important">
                     ...
                     <div class="table table-responsive" id="tblPdf"  style="display:none;">
                         <table class="table table-striped table-bordered" id="dataGridBPdfMapp">
                              <thead id="tblHeadBPdfMapp" class="bg-grey-silver !Important">
                    ...
                    <div class="table table-responsive" id="tblInv"  style="display:none;">
                         <table class="table table-striped table-bordered " id="dataGridBInvMapp">
                              <thead id="tblHeadBInvMapp" class="bg-grey-silver !Important">
        ...
        <div id="prtBTransact" style="display:none;">
          ...
          <div class="portlet light">  
                <div class="portlet-body"> 
                     <div class="table table-responsive">
                         <table class="table table-striped table-bordered" id="dataGridBTrans">
                              <thead id="tblHeadBTrans" class="bg-grey-silver !Important">
                            ...
                            <div class="col-md-12" id="dvMappDownload" style="display:none;">
                              <span style=" margin-top: 5px; text-align:right;">Mapping File :</span>
                                <div style="margin-bottom:10px;">
                                   <asp:AjaxFileUpload ID="fupFileMapp" runat="server" MaximumNumberOfFiles="1" />
                                </div>
                            </div>                                                      
...
<asp:Content ID="Content3" ContentPlaceHolderID="childScriptHolder" runat="server"> 
   ...
   <script src="../assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
    <script src="../assets/ob/obBuyerdetail.js"></script>
    <script>
        jQuery(document).ready(function () {
            $("#baseBody").fadeIn(); BuyerDetail.init();  });
    </script>
      <style type="text/css">       
          .chklabel {}
          .checkbox-grid li {display: block;float: left;width: 30%;}   
          ...
          /*.form-control {height: 25px !Important;padding-left:1px;}*/
