                 ...
                 <ul id="hTabs" class="nav nav-tabs" >
                    ...
                    <div class="portlet-body" id="portlet_bodyErr">
                         <div class="table table-responsive">
                            <table class="table table-striped table-bordered" id="dataGridErr">
                                <thead id="tblHeadErr" class="bg-grey-silver !Important">
                                    <tr id="tblHeadRowErr">                                        
                                    </tr>   
                                </thead>
                     ...
                     <div class="portlet-body" id="prtSolTemp" style="display:none;">
                         <div class="table table-responsive">
                            <table class="table table-striped table-bordered" id="dataGridSolnTemp">
                                <thead id="tblHeadSolnTemp" class="bg-grey-silver !Important">
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">
   ...
   <script src="../assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
    <link href="../assets/SM/Stylesheets/filtertable.css" rel="stylesheet" />
    <script src="../assets/ob/obErrors.js"></script>
    <script>  jQuery(document).ready(function () { Errors.init();});  </script>
      <style type="text/css">     
           #dataGridErr,#dataGridSolnTemp{margin: 0 auto;width: 100%;clear: both;border-collapse: collapse;table-layout: fixed;}  
           .FilterChkbox{ float:left!Important;padding-right:20px;}   
           input[type=checkbox] { vertical-align: middle; position: relative; bottom: 3px;}    
           .rigthAlign { padding: 5px; float: right;   width: 130px;  font-weight:bold;}
          .leftAlign { float: left;width: auto; }
          .labelPst {margin-top:4px;}
         .spanformat {font-weight:500;}
       </style>
</asp:Content>
