            ...
            <div class="portlet light">
                    <div class="portlet-body portlet-datatable" id="portlet_body">
                        <div class="table table-responsive">
                            <table class="table table-striped table-bordered" id="dataGrideInvPDFCfg">
                                <thead id="tblHeadeInvPDFCfg" class="bg-grey-silver !Important">
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">
    ...
    <script src="../assets/ob/obeInvoicePdfConfig.js"></script>
    <script> jQuery(document).ready(function () { eInvoicePDFConfig.init(); }); </script>
      <style type="text/css"> 
          .label-margin{
           ...
           #dataGrideInvPDFCfg{margin: 0 auto;width: 100%;clear: both;border-collapse: collapse;table-layout: fixed;}  
      </style>
</asp:Content>
