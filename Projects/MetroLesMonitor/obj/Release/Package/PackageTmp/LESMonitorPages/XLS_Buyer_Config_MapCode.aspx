            ...
            <div class="portlet light">
               <div class="portlet-body portlet-datatable" id="portlet_body">
                        <div class="table table-responsive">
                            <table class="table table-striped table-bordered" id="dataGridXLSByCfg">
                                <thead id="tblHeadXLSByCfg" class="bg-grey-silver !Important">
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">
    ...
    <script src="../assets/ob/obXlsBuyerConfigMapCode.js"></script>
    <script>
        jQuery(document).ready(function () { XlsBuyerConfig_MapCode.init(); });
         </script>
      <style type="text/css">
