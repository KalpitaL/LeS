...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">
    <script src="../assets/SM/LES/XlsBuyerConfig.js"></script>
    <%--<script src="../assets/ob/obXlsBuyerConfig.js"></script>--%>
    <script> jQuery(document).ready(function () {XLSBuyerConfig.init(); }); </script>
      <style type="text/css">
           #dataGridXLSByCfg{margin: 0 auto;width: 100%;clear: both;border-collapse: collapse;table-layout: fixed;}  
    </style>
</asp:Content>
