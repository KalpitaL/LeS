...
<asp:Content ID="Content3" ContentPlaceHolderID="childScriptHolder" runat="server">
    <script src="../assets/ob/obDefaultFormat.js"></script>
    <script> jQuery(document).ready(function () { DefaultFormat.init(); $('#ModalNewFormat').draggable({ handle: ".modal-header,.modal-footer" }); });</script>
</asp:Content>
