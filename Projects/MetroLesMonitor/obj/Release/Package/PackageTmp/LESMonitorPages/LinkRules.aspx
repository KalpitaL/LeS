                               ...
                               <div class="modal-body">
                                   <div class="row">
                                      <div class="col-md-12" id="dvBS">
                                         <div class="table table-responsive">
                                             <table class="table table-striped table-bordered " id="dataGridBS">
                                            <thead id="tblHeadBS" class="bg-grey-silver !Important">
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">
    ...
    <script src="../assets/ob/obLinkRule.js"></script>
    <script>jQuery(document).ready(function () { LinkRules.init(); $('#ModalNewRule,#ModalBSRulesLst,#ModalBuySupp').draggable({ handle: ".modal-header,.modal-footer" }); });   </script>
      <style type="text/css">    
    </style>
</asp:Content>
