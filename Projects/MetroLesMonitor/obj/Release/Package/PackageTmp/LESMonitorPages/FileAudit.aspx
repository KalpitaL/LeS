                        ...
                        <div class="row">
                         <div class="col-md-12">                                 
                               <div class="table-responsive ">
                                    <table class="table table-striped table-bordered table-hover" id="dataGridFAud">
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">
   ...
   <link href="../assets/SM/Stylesheets/filtertable.css" rel="stylesheet" />
    <script src="../assets/ob/obFileAudit.js"></script>
 
   <script> jQuery(document).ready(function () { FileAudit.init(); $('#ModalDetails').draggable({ handle: ".modal-header,.modal-footer" }); }); </script>
      <style type="text/css">     
           #dataGridFAud{margin: 0 auto;width: 100%;clear: both;border-collapse: collapse;table-layout: fixed;}
          </style>
</asp:Content>
