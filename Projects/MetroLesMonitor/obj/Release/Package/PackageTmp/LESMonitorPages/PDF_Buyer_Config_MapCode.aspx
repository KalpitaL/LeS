<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BaseMenu.master" AutoEventWireup="true" CodeBehind="PDF_Buyer_Config_MapCode.aspx.cs" Inherits="MetroLesMonitor.LESMonitorPages.PDF_Buyer_Config_MapCode" %>
                   ...
                   <div class="form-group">
                        <label class="control-label col-md-3" style=" margin-top: 5px; text-align:right;">Mapping File :</label>
                           <div class="col-md-9" style="padding-left:0px!important;">
                                 <asp:AjaxFileUpload ID="AjaxFileUpload1" runat="server" MaximumNumberOfFiles="1" OnUploadComplete="File_UploadComplete" 
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">  
    ...
    <script src="../assets/ob/obPDFBuyerConfigMapCode.js"></script>
    <script> jQuery(document).ready(function () { PDFBuyerConfig_MapCode.init(); }); </script>
