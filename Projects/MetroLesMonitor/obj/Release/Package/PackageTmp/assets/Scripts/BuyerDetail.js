...
var BuyerDetail = function ()  {
    ...
    var handleBuyerDetailTable = function () {
       ...
       $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
           ...
           else if (Str(target) == 'Transactions') {
               InitialiseBuyerTransactn();// GetBuyerTransactions(_FROM, _TO, BUYERID);
           }
       });   
       ...
       $('#btnNew').on('click', function (e) {
           e.preventDefault(); var activeTab = $('#hTabs .active').text();
           if (activeTab == 'Default Rules') { SetBuyerRules(BUYERID); }
       });
       ...
       $('#btnDefNew').click(function (e) {
           e.preventDefault(); var _defaddrid = BUYERID; var _defgrpformat = GetBuyerFormat(BUYERID);
           _scheckid = [];
    ...
    var setupBRulesTableHeader = function () {
        var dtfilter = '<th></th><th>Rule number</th><th>Doc Type</th><th>Rule Code</th><th>Description</th><th>Comments</th><th>Rule Value</th><th>RULE_ID</th><th>DEF_ID</th>';      
