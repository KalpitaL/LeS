...
var Buyers = function () {
    ...
    var setupTableHeader = function (_addrtype) {
        var dthead = ''; if (_addrtype.toUpperCase() == "SUPPLIER") { dthead = '<th style="display:none;">View</th><th style="display:none;"><div style="text-align:center;"><span><a style="color: #eee8e8;"><u>New</u></<a></span></div>'; } else { dthead = '<th>View</th><th><div style="width:20px;padding:1px;"><span><a style="color: #eee8e8;"><u>New</u></<a></span></div>'; }
