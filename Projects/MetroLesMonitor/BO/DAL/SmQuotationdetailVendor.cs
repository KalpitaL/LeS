namespace MetroLesMonitor.Dal {
    ...
    public partial class SmQuotationdetailVendor : IDisposable {
        
        private DataAccess _dataAccess;
        
        public SmQuotationdetailVendor() {
            this._dataAccess = new DataAccess();
        }
        
        public virtual System.Data.DataSet SM_QUOTATIONDETAIL_VENDOR_Select_All() {
            this._dataAccess.CreateProcedureCommand("sp_SM_QUOTATIONDETAIL_VENDOR_Select_All");
            DataSet value = this._dataAccess.ExecuteDataSet();
            return value;
        }
        
        public virtual System.Data.DataSet SM_QUOTATIONDETAIL_VENDOR_Select_One(System.Nullable<int> QUOTATIONDETAILID) {
            this._dataAccess.CreateProcedureCommand("sp_SM_QUOTATIONDETAIL_VENDOR_Select_One");
            this._dataAccess.AddParameter("QUOTATIONDETAILID", QUOTATIONDETAILID, ParameterDirection.Input);
            DataSet value = this._dataAccess.ExecuteDataSet();
            return value;
        }
        
        public virtual System.Nullable<int> SM_QUOTATIONDETAIL_VENDOR_Insert(
                    ...
                    string BuyerORGRef) {
            this._dataAccess.CreateProcedureCommand("sp_SM_QUOTATIONDETAIL_VENDOR_Insert");
        ...
        public virtual System.Nullable<int> SM_QUOTATIONDETAIL_VENDOR_Delete(System.Nullable<int> QUOTATIONDETAILID) {
            this._dataAccess.CreateProcedureCommand("sp_SM_QUOTATIONDETAIL_VENDOR_Delete");
            this._dataAccess.AddParameter("QUOTATIONDETAILID", QUOTATIONDETAILID, ParameterDirection.Input);
            int value = this._dataAccess.ExecuteNonQuery();
            return value;
        }
        
        public virtual System.Nullable<int> SM_QUOTATIONDETAIL_VENDOR_Update(
                    ...
                    string VENDOR_ITEMNAME, 
                    string BuyerORGRef) {
            this._dataAccess.CreateProcedureCommand("sp_SM_QUOTATIONDETAIL_VENDOR_Update");
            this._dataAccess.AddParameter("QUOTATIONDETAILID", QUOTATIONDETAILID, ParameterDirection.Input);
            this._dataAccess.AddParameter("QUOTATIONID", QUOTATIONID, ParameterDirection.Input);
            this._dataAccess.AddParameter("ITEMSTATUS", ITEMSTATUS, ParameterDirection.Input);
            this._dataAccess.AddParameter("ITEMNO", ITEMNO, ParameterDirection.Input);
