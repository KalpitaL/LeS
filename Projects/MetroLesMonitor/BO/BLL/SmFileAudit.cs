...
namespace MetroLesMonitor.Bll
{
    public partial class SmFileAudit
    {
        ...
        private void Fill(System.Data.DataRow dr)
        {
            ...
            {
                this.ByrDownloaded = ((System.Nullable<System.DateTime>)(dr["UPDATE_DATE"]));
            }
        }

        public static System.Data.DataSet GetRecords()
        {
            MetroLesMonitor.Dal.SmFileAudit dbo = null;
            try
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                System.Data.DataSet ds = dbo.SM_FILE_AUDIT_Select_All();
        ...
        public static System.Data.DataSet GetRecords(DateTime FromDate,DateTime ToDate)
        {
            MetroLesMonitor.Dal.SmFileAudit dbo = null;
            try
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                System.Data.DataSet ds = dbo.SM_FILE_AUDIT_Select_All(FromDate,ToDate);
                if (GlobalTools.IsSafeDataSet(ds))
                {
                    return ds;
                }
        ...
        public static System.Data.DataSet GetRecords_Filter(DateTime FromDate, DateTime ToDate,string FilterData)
        {
            MetroLesMonitor.Dal.SmFileAudit dbo = null;
            try
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                System.Data.DataSet ds = dbo.SM_FILE_AUDIT_Select_Filter(FromDate, ToDate,FilterData);
                if (GlobalTools.IsSafeDataSet(ds))
                {
                    return ds;
                }
        ...
        public static System.Data.DataSet GetRecords_Filterdet(DateTime FromDate, DateTime ToDate,string cSrchFilter, string SEARCH,string SELECTCOND)
        {
            MetroLesMonitor.Dal.SmFileAudit dbo = null;
            try
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                System.Data.DataSet ds = dbo.SM_FILE_AUDIT_SelectDetails(FromDate, ToDate,cSrchFilter, SEARCH, SELECTCOND);
                if (GlobalTools.IsSafeDataSet(ds))
                {
                    return ds;
                }
        ...
        public static System.Data.DataSet GetFileAuditInfo(int RECORDID)
        {
            MetroLesMonitor.Dal.SmFileAudit dbo = null;
            try
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                System.Data.DataSet ds = dbo.SM_FILE_AUDIT_Select_One(RECORDID);
                if (GlobalTools.IsSafeDataSet(ds))
                {
                    return ds;
                }
        ...
        public static SmFileAuditCollection GetAll()
        {
            MetroLesMonitor.Dal.SmFileAudit dbo = null;
            try
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                System.Data.DataSet ds = dbo.SM_FILE_AUDIT_Select_All();
                SmFileAuditCollection collection = new SmFileAuditCollection();
                if (GlobalTools.IsSafeDataSet(ds))
                {
                    for (int i = 0; (i < ds.Tables[0].Rows.Count); i = (i + 1))
                    {
                        SmFileAudit obj = new SmFileAudit();
        ...
        public static System.Data.DataSet GetFileAudit()
        {
            MetroLesMonitor.Dal.SmFileAudit dbo = null;
            try
            {
        ...
        public static SmFileAudit Load(System.Nullable<int> RECORDID)
        {
            MetroLesMonitor.Dal.SmFileAudit dbo = null;
            try
            {
        ...
        public virtual void Load()
        {
            ...
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                System.Data.DataSet ds = dbo.SM_FILE_AUDIT_Select_One(this.Recordid);
                if (GlobalTools.IsSafeDataSet(ds))
                {
                    if ((ds.Tables[0].Rows.Count > 0))
                    {
        ...
        public virtual void Insert()
        {
            ...
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                dbo.SM_FILE_AUDIT_Insert(this.Vrno, this.DocFilename1, this.DocFilename2, this.Buyerid, this.Supplierid, this.ByrUploaded, this.ByrImported, this.SupExported, this.SupDownloaded, this.SupUploaded, this.SupImported, this.ByrExported, this.ByrDownloaded);
            }
            catch (System.Exception)
            {
                throw;
        ...
        public virtual void Delete()
        {
            ...
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                dbo.SM_FILE_AUDIT_Delete(this.Recordid);
            }
            catch (System.Exception)
            {
                throw;
        ...
        public virtual void Update()
        {
            ...
            {
                dbo = new MetroLesMonitor.Dal.SmFileAudit();
                dbo.SM_FILE_AUDIT_Update(this.Recordid, this.Vrno, this.DocFilename1, this.DocFilename2, this.Buyerid, this.Supplierid, this.ByrUploaded, this.ByrImported, this.SupExported, this.SupDownloaded, this.SupUploaded, this.SupImported, this.ByrExported, this.ByrDownloaded);
            }
            catch (System.Exception)
            {
                throw;
