                      ...
                      <div id="prtDefRules">
                         ...
                         <div class="portlet-body"> 
                               <div class="table table-responsive">
                                    <table  class="table table-bordered table-striped" id="dataGridDRule">
                                        <thead id="tblHeadDRule">
...
<link href="../assets/Login/css/plugins.css" rel="stylesheet" />
   <style type="text/css">     
    ...
    <script src="../assets/Scripts/min/jquery.bootstrap.wizard.new.js"></script>
    <script src="../assets/Scripts/ob/ServerSyncWizard.js"></script>
