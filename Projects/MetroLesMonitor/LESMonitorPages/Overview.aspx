            ...
            <div class="portlet light">
               <div class="portlet-body">                                                               
                   <div class="table table-responsive">
                        <table class="table  table-bordered table-striped" id="dataGridBuyer">  
                             <thead id="tblHeadBuyer">   <tr id="tblHeadRowBuyer">  </tr>   </thead>
            ...
            <div class="portlet-body">  
                 <div class="table table-responsive">                                                                        
                     <table class="table  table-bordered table-striped" id="dataGridSupp">
                       <thead id="tblHeadSupp"> <tr id="tblHeadRowSupp"> </tr>   </thead>
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">
    <link href="../assets/css/Overview.css" rel="stylesheet" />
        <script src="../assets/Scripts/ob/Overview.js"></script>
