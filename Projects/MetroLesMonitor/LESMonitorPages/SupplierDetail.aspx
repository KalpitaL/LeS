      ...
      <div class="row">
        ...
        <div id="prtSuppRules" style="display:none;">     
            <div class="portlet light">  
                <div class="portlet-body"> 
                     <div class="table table-responsive">
                         <table class="table  table-bordered table-striped" id="dataGridSRules">
                            <thead id="tblHeadSRule">
          ...
          <div class="portlet light">  
                <div class="portlet-body"> 
                     <div class="table table-responsive" id="tblXls" >
                         <table class="table  table-bordered table-striped" id="dataGridSXlsMapp">
                              <thead id="tblHeadSXlsMapp">
                     ...
                     <div class="table table-responsive" id="tblPdf"  style="display:none;">
                         <table class="table  table-bordered table-striped" id="dataGridSPdfMapp">
                              <thead id="tblHeadSPdfMapp">
        ...
        <div id="prtSTransact" style="display:none;">
           <div id="dvOverview" style="display:none;">
            ...
            <div class="portlet light form-fit" id="divFilter">
                ...
                <div class="portlet-body"> 
                     <div class="table table-responsive">
                         <table class="table  table-bordered table-striped" id="dataGridSTrans">
                              <thead id="tblHeadSTrans">
                             ...
                             <div class="row" id="prtItemRef" style="display:none;">
                                 <div class="col-md-12" id="dvItemref">
                                     <div class="portlet light" id="prtBSItemRef">
                                         <div class="portlet-body">
                                            <div class="table table-responsive">
                                                <table class="table  table-bordered table-striped" id="dataGridBSItemRef">
                                                   <thead id="tblHeadBSItemRef">
                             ...
                             <div class="row" id="prtItemUOM" style="display:none;">
                                 <div class="col-md-12" id="dvItemUOM">
                                     <div class="portlet light" id="prtBSItemUOM">
                                         <div class="portlet-body">
                                            <div class="table table-responsive">
                                                <table class="table  table-bordered table-striped" id="dataGridBSItemUOM">
                                                   <thead id="tblHeadBSItemUOM">
                            ...
                            <div class="row" id="prtBSLnkRules" style="display:none;">
                                 <div class="col-md-12" id="dvBSLnkRules">
                                    <div class="portlet light" id="prtBSLkRules">
                                        <div class="portlet-body">
                                          <div class="table table-responsive">
                                              <table class="table  table-bordered table-striped" id="dataGridBSLnkRules">
                                                 <thead id="tblHeadBSLnkRules">   <tr id="tblHeadRowBSLnkRules">  </tr> </thead>
                                                       ...
                                                       <div>
                                                         <span style=" margin-top: 5px; text-align:right;">Mapping File :</span>
                                                              <div style="margin-bottom:10px;">
                                                                <ajaxToolkit:AjaxFileUpload ID="fupFileMapp" runat="server" MaximumNumberOfFiles="1" OnUploadComplete="File_UploadComplete" 
...
<asp:Content ID="Content3" ContentPlaceHolderID="childScriptHolder" runat="server">  
    <link href="../assets/css/supplierdetail.css" rel="stylesheet" />
    <script src="../assets/Scripts/ob/SupplierDetail.js"></script>
    <script>
        jQuery(document).ready(function () {
            SupplierDetail.init(); $("#baseBody").fadeIn();
            //$('#ModalBSdet,#ModalNewBSItemRef,#ModalNewBSUOMItemRef,#ModalUpload,#ModalLoginInfo,#ModalLnkBuySupp,#ModalNewBSItemDet').draggable({ handle: ".modal-header,.modal-footer" });
        });
    </script>
      <style type="text/css">
