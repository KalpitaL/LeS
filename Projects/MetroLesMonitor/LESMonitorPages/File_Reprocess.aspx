                                                ...
                                                <div class="row"> 
                                                 <div class="col-md-12">
                                                  ...
                                                  <div class="col-md-12">
                                                      ...
                                                      <asp:FileUpload  ID="AjaxFileUpload1" runat="server" MaximumNumberOfFiles="1" Width="100%" OnUploadComplete="File_UploadComplete" 
                                                     OnClientUploadComplete="onClientUploadComplete" OnClientUploadStart="onClientUploadStart" ViewStateMode="Enabled"/>
                                                    </div>
                                                       </div>
                                                  </div>
                                                </div>
                              ...
                              <div class="col-md-12">
                                   <div class="portlet box blue">
                                      ...
                                      <div class="portlet-body" id="portlet_bodyexp">     
                                          ...
                                          <table class="table  table-bordered table-striped" id="dataGridExp">
                                              <thead id="tblHeadExp">
                                             </thead>
                                  ...
                                  <div class="portlet-body"  id="portlet_body1">
                                    <div class="row">
                                      <div class="col-md-12" id="dvSuppDet">
                                        ...
                                        <table class="table  table-bordered table-striped" id="dataGridSupp">
                                            <thead id="tblHeadSupp">
                              ...
                              <div class="modal-body">        
                                  <div class="row">
                                      <div class="col-md-12" id="dvNuyDet">            
                                            <div class="table-responsive">
                                        <table class="table  table-bordered table-striped" id="dataGridByer">
                                            <thead id="tblHeadByer">
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">
   <script src="../assets/Scripts/ob/FileReprocess.js"></script>
  <script>   jQuery(document).ready(function () { FileReprocess.init();  });</script>
</asp:Content>
<%--$('#ModalSupplier,#ModalBuyer').draggable({ handle: ".modal-header,.modal-footer" });--%>