            ...
            <div class="portlet light">           
                    <div class="portlet-body" id="portlet_body">
                        <div class="table table-responsive">
                            <table class="table  table-bordered table-striped" id="dataGrideInvLnk">
                                <thead id="tblHeadeInvLnk">
                               ...
                               <div class="modal-body">
                                   <div class="row">
                                      <div class="col-md-12" id="dvBSInv">
                                         <div class="table table-responsive">
                                             <table class="table  table-bordered table-striped" id="dataGridBSInv">
                                            <thead id="tblHeadBSInv">
                           ...
                           <div class="row">
                            <div class="col-md-12 col-sm-12">  <div class="portlet custom">  <div class="portlet-title margin-bottom-0">  <div id="Itemtoolbtngroup"> </div></div> </div>  </div>
                                 <div class="col-md-12" id="dvBSInvAcc">
                                         <div class="table table-responsive">
                                             <table class="table  table-bordered table-striped" id="dataGridBSInvAcc">
                                            <thead id="tblHeadBSInvAcc">
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">        
    <script src="../assets/Scripts/ob/eInvoiceLinks.js"></script>
    <script> jQuery(document).ready(function () { eInvoiceLinks.init();  }); </script>
</asp:Content>
<%--$('#ModalBSInv,#ModalBSInvAcc,#ModalNewInvAcc').draggable({ handle: ".modal-header,.modal-footer" });--%>