    ...
    public partial class AuditGrid : System.Web.UI.Page
    {
        ...
        void Bind()
        {
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0 )
                {
                    ...
                    {
                        BindCombo((DropDownList)gvData.HeaderRow.FindControl("ddlModule"));
                    }
                }
        ...
        private void BindCombo(DropDownList ddl)
        {
            ...
            if (ddl != null)
            {
                ...
                {
                    dsModule = (DataSet)Session["ModuleSource"];
                }
                else
                {
                ...
                Session["ModuleSource"] = dsModule;
                ddl.DataValueField = "MODULENAME";
                ddl.DataTextField = "MODULENAME";
                ddl.DataBind();

                if (!string.IsNullOrEmpty(ddlVal)) ddl.Items.FindByText(Convert.ToString(ViewState["ddlModuleValue"])).Selected = true;
            }
        }
        ...
        private void Clear()
        {
            ...
            dtFrom = Convert.ToDateTime(cToday).ToString("yyyy-MM-dd"); dtTo = Convert.ToDateTime(cToday).ToString("yyyy-MM-dd");
            Bind();
        }
