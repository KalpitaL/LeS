...
<asp:Content ID="Content3" ContentPlaceHolderID="childScriptHolder" runat="server">
    <script src="../assets/Scripts/ob/DocumentFormat.js"></script>
    <script> jQuery(document).ready(function () { DocumentFormat.init(); });</script>
</asp:Content>

 <%--$('#ModalNewFormat,#ModalDefFmtRuleDet,#ModalNewRule').draggable({ handle: ".modal-header,.modal-footer" });--%>