            ...
            <div class="portlet light">
                <div class="portlet-body" id="portlet_body">
                        <div class="table table-responsive">                       
                            <table class="table  table-bordered table-striped" id="dataGridGrp">
                                <thead id="tblHeadGrp">
                                    <tr id="tblHeadRowGrp">                                        
                                    </tr>         
                                </thead>
...
<asp:Content ID="Content4" ContentPlaceHolderID="childScriptHolder" runat="server">  
    <script src="../assets/Scripts/ob/Groups.js"></script>
    <script>  jQuery(document).ready(function () { Groups.init();}); </script>
</asp:Content>

 <%--$('#ModalNew,#ModalLnkRules,#ModalLnkBuySupp').draggable({ handle: ".modal-header,.modal-footer" }); --%>