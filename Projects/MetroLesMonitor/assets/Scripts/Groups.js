...
var Groups = function () {
    ...
    var setupRuleTableHeader = function () {
        var dtfilter = '<th style="text-align:center;">#</th><th>Rule Number</th><th>Doc Type</th><th>Rule Code</th><th>Description</th><th>Comments</th><th>Rule Value</th><th>GROUP_ID</th><th>RULEID</th>';
    ...
    var setupTableHeader = function () {
        setFilterToolbar();
        var dtfilter = '<th style="text-align:center;">#</th><th></th><th>Group Code</th><th>Group Description</th><th>Buyer <br/> Import Format</th><th>Supplier <br/> Export Format</th><th>Buyer <br/> Export Format</th><th>Supplier <br/> Import Format</th>' +
