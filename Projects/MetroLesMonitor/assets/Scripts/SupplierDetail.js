 ...
 var oNDRTable = ''; var oBSRTable = ''; var oBSItemUMTable = ''; var _lstSyncservers = []; var _lstControlsname = [];
   ...
   var handleSupplierDetailTable = function () {
           ...
           $('#btnNew').on('click', function (e) {
               ...
               else if (activeTab == 'Default Rules') {
                   var _defgrpformat = GetSupplierFormat(SUPPLIERID);
                   if (_defgrpformat != '' && _defgrpformat != undefined) { SetSupplierRules(); } else { toastr.error("Lighthouse eSolutions Pte. Ltd.", 'Select Group'); }
               }
           });
   ...
   $('#btnDefNew').click(function (e) {
       e.preventDefault(); var _defaddrid = SUPPLIERID; var _defgrpformat = GetSupplierFormat(SUPPLIERID); _scheckid = [];
       $('input[type=checkbox]:checked').each(function () {
  ...
  /*end*/      
       ...
       var setupBSTableHeader = function () {
           ...
           var dtfilter = '<th class="text-center">#</th><th><div style="text-align:center;display:none;"><span><a style="color: #1c1b1b;"><u>New</u></<a></span></div></th><th>LinkId</th><th>Buyer Code</th><th>Buyer Name</th>  <th>Buyer Link Code</th>' +
      ...
      /*Buyer Supplier Link Rules*/
       ...
       var setupBSRulesTableHeader = function () {
           var dtfilter = '<th style="text-align:center;">#</th><th>Rule No.</th><th>Doc Type</th><th>Rule Code</th><th>Description</th><th>Comments</th><th>Rule Value</th><th>Is Inherit</th><th>RULEID</th>';
       ...
       var setupNewRulesTableHeader = function () {
           var dtfilter = '<th style="text-align:center;">#</th><th>Rule No.</th><th>Doc Type</th><th>Rule Code</th><th>Rule Desc</th><th>RULEID</th>';
       ...
       var setupBSItemTableHeader = function () {
           var dtfilter = '<th><div style="text-align:center;display:none;"><span><a style="color: #1c1b1b;"><u>New</u></<a></span> <span><a style="color: #1c1b1b;"><u>Upload</u></<a></span></div></div></th><th>Ref. Type</th><th>Buyer Ref.</th><th>Supplier Ref.</th>' +
       ...
       var setupBSItemUOMTableHeader = function () {
           var dtfilter = '<th><div style="text-align:center;display:none;"><span><a style="color: #1c1b1b;"><u>New</u></<a></span> <span><a style="color: #1c1b1b;"><u>Upload</u></<a></span></div></th><th>Buyer Item UOM.</th><th>Supplier Item UOM.</th><th>BUYER_ID</th>' +
       ...
       var setupRulesTableHeader = function () {
           var dtfilter = '<th style="text-align:center;">#</th><th>Rule No.</th><th>Doc Type</th><th>Rule Code</th><th>Description</th><th>Comments</th><th>Rule Value</th><th>RULEID</th>';
