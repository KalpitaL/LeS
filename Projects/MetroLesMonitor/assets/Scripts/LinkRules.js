...
var LinkRules = function () {
    ...
    var setupBSTableHeader = function () {
        var dtfilter = '<th style="text-align;center;">#</th><th>Code</th><th>Buyer Name</th><th>Buyer Link Code</th><th>Supplier Link Code</th><th>Buyer Format</th> <th>Buyer Export Format</th><th>Supplier\n Format</th><th>Supplier Export\n Format</th><th>Vendor Export Path</th><th>Group</th><th>Notify Buyer</th><th>Notify Supplier</th><th>Active</th><th>BUYERID</th><th>LINKID</th>';
    ...
    var setupBSRulesTableHeader = function () {
        var dtfilter = '<th><div style="text-align:center;"><span><a style="color: #1c1b1b;"><u>New</u></<a></span></div></th><th>Rule number</th><th>Doc Type</th><th>Rule Code</th><th>Description</th><th>Comments</th><th>Rule Value</th><th>Is Inherit</th><th>RULEID</th>';
    ...
    var setupTableHeader = function (_addrtype) {
        ...
        if (_addrtype.toUpperCase() == "BUYER") { dthead = '<th style="display:none; text-align:center;">#</th>'; } else { dthead = '<th style="text-align:center;">#</th>'; }
