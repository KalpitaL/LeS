...
var PDFBuyerConfig = function () {
    ...
    var handlePDFBuyerConfigTable = function () {
        ...
        var oPMTable = table.dataTable({
           ...
           { 'targets': [0], width: '88px' }, { 'targets': [1], width: '42px' },// { 'targets': [2], width: '100px', "sClass": "break-det" },
           { 'targets': [3], width: '75px' }, { 'targets': [4, 6], width: '45px' }, { 'targets': [2, 9, 11, 13], width: '90px', "sClass": "break-det" },
