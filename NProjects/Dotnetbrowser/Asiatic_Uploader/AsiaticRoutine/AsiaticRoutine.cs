      ...
      // if (NavigateToURL(strMessageNumber, Path.GetFileName(MTML_QuoteFile), strMTMLUploadPath) && strUCRefNo != "")   //commented by kalpita on 27/03/2020
                                ...
                                if (eRow != null)
                                {
                                    ...
                                    if (_item.Quantity != 0)
                                    {
                                        ...
                                        if (_qty != null)
                                        {
                                          ...
                                          //changed by kalpita on 28042020

                                            _qty.Focus();
                                            ((DOMInputElement)_qty).Value = ""; ((DOMInputElement)_qty).Value = Convert.ToString(_item.Quantity);
                                    ...
                                    {
                                        _pricePerUnit.Focus();
                                        string val = ((DOMInputElement)_pricePerUnit).Value;
                                        if (string.IsNullOrEmpty(val)) { SetValue(_pricePerUnit, _price, "input"); }

                                        //changed by kalpita on 28042020
                                       
                                      //  ((DOMInputElement)_pricePerUnit).Value = ""; ((DOMInputElement)_pricePerUnit).Value = _price;
                                        ...
                                        //if (_pricePerUnit1 != null)
                                        //{
                                        //    _pricePerUnit1.Focus();
                                        //    ((DOMInputElement)_pricePerUnit1).Value = ""; ((DOMInputElement)_pricePerUnit1).Value = TotalPrice;
                                           
                                        //}
                                    }
                                  
                                    #endregion//checking pending
        ...
        public bool Fill_ExtraItem_Details(string MTML_QuoteFile)
        {
            ...
            foreach (LineItem lItem in lstExtraItems)
            {
                ...
                fillExtraItems(counter, _price, lItem.Description, lItem.Quantity, lItem.MeasureUnitQualifier, lItem.MonetaryAmount.ToString("0.00"));
        ...
        public void fillExtraItems(int counter, string _str, string _tag, double _qty, string _unit, string TotalPrice)
        {
            DOMElement _btnAddItem = _netWrapper.GetElementByType("button", "click:$component.addItem.bind($component)", "data-bind");
            if (_btnAddItem != null)
            {
