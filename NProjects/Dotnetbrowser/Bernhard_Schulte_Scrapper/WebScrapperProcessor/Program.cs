...
namespace WebScrapperProcessor
{
    class Program
    {
        ...
        public static bool IsProcessRunning()
        {
            ...
            //Process[] p = Process.GetProcesses();//commented on 6-6-2017
            //string cFormName = "WebScrapperProcessor";//commented on 6-6-2017
            ...
            //if (runningProcessByName.Length <= 1)//commented on 6-6-2017
            if (nCnt <= 1)
            {
                return false;
            }
