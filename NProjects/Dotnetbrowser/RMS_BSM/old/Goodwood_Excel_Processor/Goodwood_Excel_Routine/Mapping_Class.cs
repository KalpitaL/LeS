...
namespace Excel_SPL_Routine
{
            ...
            if (_Node != null)
            {
                ...
                switch (_type)
                {
                    ...
                    case "VALIDATE_SUPPLIER":
                        ...
                        break;
                    case "VALIDATE_BUYER_SINGAPORE":
                        obj.Validate_Buyer_Singapore = (_hdata);
                        break;
                    case "VALIDATE_SUPPLIER_SINGAPORE":
                        obj.Validate_Supplier_Singapore = (_hdata);
                        break;
                    case "HEAER_DATA":
        ...
        public void SetItemDataValues(XmlNode _Node, ITEM_MAPPINGS obj)
        {
            try
            {
                if (_Node != null)
                {
                    ...
                    if (_Node.Attributes["IS_ITEM_REMARKS"] != null)
                    { _Idata.IsRemarks = convert.ToString(_Node.Attributes["IS_ITEM_REMARKS"].Value); }
                    switch (_type)
                    {
                        case "ITEM_START":
    ...
    public class HEADER_MAPPINGS
    {
        ...
        public HDATA Validate_Supplier_Singapore = new HDATA();
        public HDATA Validate_Buyer_Singapore = new HDATA();
